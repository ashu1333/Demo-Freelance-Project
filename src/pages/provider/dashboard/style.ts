...
const useStyles = makeStyles(() => ({
  ...
  modelTitle : {
    backgroundColor: '#8ec6d7', color:'#fff', padding:'15px 20px 15px 25px', fontWeight:'lighter',
    fontSize : '18px',
    textAlign : 'left',
    fontFamily:'Futura PT Book',
  },
  ...
  modelTitleT1 : {
    padding:'10px 10px 10px 20px', fontWeight:'lighter',
    fontSize : '20px',
    textAlign : 'left',
    fontFamily:'Futura PT Book',
    color:'#000',
  ...
  modelText : {
    padding:'10px 10px 40px 20px', fontWeight:'lighter',
    fontSize : '16px',
    textAlign : 'left',
    fontFamily:'Futura PT Book',
    color:'#000',
